...
export const createStore = <INITIAL_STATE extends TAnyObject, ADDITIONAL_STATE extends TAnyObject>(
  initialState: INITIAL_STATE,
  additionalStateCreator: StateCreator<INITIAL_STATE, TMods, TMods, ADDITIONAL_STATE>,
  storeName?: string,
) => {
